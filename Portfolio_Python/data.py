...
class Info:
    def __init__(self, icon, title, subtitle, description, date="", certificate="", technologies=[], image="", url="", github="", alt="Portadas de web"):
        self.icon = icon
        self.title = title
...
class Extra:
    def __init__(self, image, title, description, url, alt):
        self.image = image
        self.title = title
        self.description = description
        self.url = url
